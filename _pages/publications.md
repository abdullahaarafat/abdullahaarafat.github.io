...
Conference Papers
======
1.  <span style="color:red">[RTAS 2023]</span> Kurt Wilson, **Abdullah Al Arafat**, John Baugh, Ruozhou Yu, and Zhishan Guo. [Physics-Informed Mixed-Criticality Scheduling for F1Tenth Cars with Preemptable ROS 2 Executors](), in *IEEE 31st Real-Time and Embedded Technology and Applications Symposium **(RTAS)**, 2025.*
1. **[HSCC 2025]** Kurt Wilson<b><sup>\*</sup></b>, **Abdullah Al Arafat**<b><sup>\*</sup></b>, John Baugh, Ruozhou Yu, Xue Liu, and Zhishan Guo. [Soteria: A Formal Digital-Twin Framework for Safety-Assurance of Latency-Aware Safety-Critical Cyber-Physical Systems](), in *28th ACM International Conference on Hybrid Systems: Computation and Control **(HSCC)**, 2025.*
