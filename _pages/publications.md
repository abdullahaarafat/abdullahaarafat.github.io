...
<ol reversed>
  ...
  <li><strong>[DATE 2026]</strong> Sabbir Ahmed, Deniz Najafi, Mohaiminul Al Nahian, Navid Khoshavi, <strong>Abdullah Al Arafat</strong>, Mamshad Nayeem Rizve, Mahdi Nikdast, Adnan Siraj Rakin, and Shaahin Angizi. <a href="">INSPIRE: In-Sensor Compressed Weight Retrieval for Enhancing ViT Efficiency at Edge</a>, in <em>IEEE/ACM Design, Automation and Test in Europe <strong>(DATE)</strong>, 2026. </em><span style="color:red"> <strong> (Best Paper Award Nominations)</strong></span></li>
