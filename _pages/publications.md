...
1.  <span style="color:red">[RTAS 2025]</span> Kurt Wilson, **Abdullah Al Arafat**, John Baugh, Ruozhou Yu, and Zhishan Guo. [Physics-Informed Mixed-Criticality Scheduling for F1Tenth Cars with Preemptable ROS 2 Executors](https://abdullahaarafat.github.io/files/2025RTAS.pdf), in *IEEE 31st Real-Time and Embedded Technology and Applications Symposium **(RTAS)**, 2025.*
1. **[RTCSA 2025]** **Abdullah Al Arafat**, Kurt Wilson, Sudharsan Vaidhun, Bryan C. Ward, and Zhishan Guo. [Resilient Scheduling of Real-Time Cyber-Physical Systems against Memory-Corruptions](), in *The 31th IEEE International Conference on Embedded and Real-Time Computing Systems and Applications **(RTCSA)**, 2025.*
1. **[RTCSA 2025]** Yixin Li, **Abdullah Al Arafat**, Donald Johnson, Ning Sui, Anil Gehi, and Zhishan Guo. [Adaptive Model Selection for Real-Time Heart Disease Detection on Embedded Systems](), in *The 31th IEEE International Conference on Embedded and Real-Time Computing Systems and Applications **(RTCSA)**, 2025.*
...
1. **[ICCAD 2025]** Abeer Almalky, Sabbir Ahmed, Ranyang Zhou, Mohaiminul Al Nahian, **Abdullah Al Arafat**, Shaahin Angizi, and Adnan Siraj Rakin. [LLWRA: Large Language Models Weight Replacement Attack](), in *IEEE/IFAC 9th International Conference on Control, Automation and Diagnosis **(ICCAD)**, 2025.*
