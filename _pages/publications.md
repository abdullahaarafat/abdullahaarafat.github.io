...
<ol reversed>
  <li><span style="color:red">[CVPR 2025]</span> Sabbir Ahmed<sup>*</sup>, <strong>Abdullah Al Arafat</strong><sup>*</sup>, Deniz Najafi<sup>*</sup>, Akhlak Mahmood, Mamshad Nayeem Rizve, Mohaiminul Al Nahian, Ranyang Zhou, Shaahin Angizi, and Adnan Siraj Rakin. <a href="#">DeepCompress-ViT: Rethinking Model Compression to Enhance Efficiency of Vision Transformers at the Edge</a>, in <em>IEEE/CVF Computer Vision and Pattern Recognition Conference <strong>(CVPR)</strong>, 2025.</em></li>
  
  <li><strong>[RTCSA 2025]</strong> <strong>Abdullah Al Arafat</strong>, Kurt Wilson, Sudharsan Vaidhun, Bryan C. Ward, and Zhishan Guo. <a href="#">Resilient Scheduling of Real-Time Cyber-Physical Systems against Memory-Corruptions</a>, in <em>31st IEEE International Conference on Embedded and Real-Time Computing Systems and Applications <strong>(RTCSA)</strong>, 2025.</em></li>
  
  <li><strong>[RTCSA 2025]</strong> Yixin Li, Zhiling Li, <strong>Abdullah Al Arafat</strong>, Donald Johnson, Ning Sui, Anil Gehi, and Zhishan Guo. <a href="#">Adaptive Model Selection for Real-Time Heart Disease Detection on Embedded Systems</a>, in <em>31st IEEE International Conference on Embedded and Real-Time Computing Systems and Applications <strong>(RTCSA)</strong>, 2025.</em></li>
  
  <li><span style="color:red">[RTAS 2025]</span> Kurt Wilson, <strong>Abdullah Al Arafat</strong>, John Baugh, Ruozhou Yu, and Zhishan Guo. <a href="https://abdullahaarafat.github.io/files/2025RTAS.pdf">Physics-Informed Mixed-Criticality Scheduling for F1Tenth Cars with Preemptable ROS 2 Executors</a>, in <em>31st IEEE Real-Time and Embedded Technology and Applications Symposium <strong>(RTAS)</strong>, 2025.</em></li>
